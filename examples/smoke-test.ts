...
const CALLS: Array<{ path: string; expect: string; price: string }> = [
  ...
  { path: "/v1/eu/agrements?q=BNP%20Paribas", expect: "supervision_bce", price: "$0.01" }, // five registers since 17/09/2026: ESMA MiFID + ECB list of supervised entities + ESMA benchmark administrators + ESMA money market funds + EIOPA IORPs
